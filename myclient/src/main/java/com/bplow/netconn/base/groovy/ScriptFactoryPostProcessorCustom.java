...
import com.bplow.netconn.base.utils.LoggerUtil;

public class ScriptFactoryPostProcessorCustom extends InstantiationAwareBeanPostProcessorAdapter
                                                                                                implements
    ...
    private Logger logger = LoggerFactory.getLogger(ScriptFactoryPostProcessorCustom.class);
    ...
    protected ScriptSource convertToScriptSource(String beanName, String scriptSourceLocator,
        ...
        if (scriptSourceLocator.startsWith(INLINE_SCRIPT_PREFIX)) {
            ...
            return new DatabaseScriptSource(scriptSourceLocator.substring(DATABASE_SCRIPT_PREFIX
                .length()), dataSource);
        } else {
    ...
    public Class predictBeanType(Class beanClass, String beanName) {
        ...
        try {
            ...
            if (ex.getMostSpecificCause() instanceof BeanCurrentlyInCreationException) {
                LoggerUtil.debug(logger, "Could not determine scripted object type for bean '",
    ...
    */
    ...
    public void destoryBean(String beanName) {
        ...
        this.scriptBeanFactory.removeBeanDefinition(customedBeanName);
    }
